package com.niravmadariya.fullnavigationdrawer.View;
...
public class FullNavigationDrawer extends DrawerLayout {

    private static final int MIN_DRAWER_MARGIN = 0; // dp

    public FullNavigationDrawer(Context context) {
        super(context);
    }

    public FullNavigationDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FullNavigationDrawer(Context context, AttributeSet attrs, int defStyle) {
